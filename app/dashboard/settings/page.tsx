    ...
    <main className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Gerencie horários de trabalho e bloqueios
        </p>
      </div>
        ...
        <TabsContent value="schedule">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure os horários de trabalho de cada profissional por dia
                da semana
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="blocks">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Bloqueie períodos específicos na agenda dos profissionais
              </CardDescription>
            </CardHeader>
            <CardContent>
              <BlocksManager />
